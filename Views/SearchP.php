...
<body>
	...
	<section id="content">
		...
		<nav>
			...
			<form action="./Search.php?t=Properties" method="post">
		...
		<main>
          ...
          foreach ($result as $res):?>
					<a href="\Scrape_Project\Views\Post.php?t=Properties&pid=<?php echo $res['PropertyID']?>">
          <?php $post = $user->ShowPropertiesByID($res['PropertyID']) ?>
            <div class="Cards_Cars">
						...
						<div class="card_content">
							...
							<div class="name_ville_cards"><?php echo $post['Address'] ?></div>
							<div class="moduleCars_and_horsPower">
								<i class='bx bx-calendar'></i><small><?php echo $post['YearBuilt'] ?></small>
								<i class='bx bx-ruler'></i><small><?php echo $post['LotSize'] ?> m²</small>
